...
extension SEPCrypto {
    /// encrypt AES-256 GCM
    public static func encryptAES256GCM(data: Data, key: Data, nonce: AES.GCM.Nonce = .init()) throws -> Data {
    ...
    /// decrypt AES-256 GCM
    public static func decryptAES256GCM(data: Data, key: Data) throws -> Data {
        let symmetricKey = SymmetricKey(data: key)
...
extension String {
    ...
    public func encryptAES256(key: Data, nonce: AES.GCM.Nonce = .init()) throws -> Data {
    ...
    public func decryptAES256(key: Data) throws -> Data {
    ...
    public func encryptAES256(key: Data, nonce: AES.GCM.Nonce = .init()) throws -> String {
        try (encryptAES256(key: key, nonce: nonce) as Data).toHexadecimal
    }

    public func decryptAES256(key: Data) throws -> String {
    ...
    public func encryptAES256(key: String, nonce: Data? = nil) throws -> String {
    ...
    /// Key will be converted to hex
    public func decryptAES256(key: String) throws -> String {
        let convertedKey: Data = try key.convertToAESKey()
        return try decryptAES256(key: convertedKey)
    }
    
    public func convertToAESKey() throws -> Data {
        let data: Data = Data(self.utf8)
        return Data(SHA256.hash(data: data))
    }
    
    public func toAESKey() throws -> Data { try convertToAESKey() }
}
